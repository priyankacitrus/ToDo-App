            ...
            <Grid>
                <Paper elevation={10} style={{ padding: 20, height: '70vh', width: 280, margin: "20px auto" }}>
                    <Grid align='center' style={{ marginTop: "20px" }}>
                        <Avatar style={{ backgroundColor: 'red' }}><LockIcon /></Avatar>
                        <h2>Sign In</h2>
                    </Grid>
                    <TextField label='Email'
                        placeholder='Enter email'
                        fullWidth required style={{ marginBottom: "20px" }}
                    ...
                    onClick={handleLogin}
                    variant="contained" style={{ margin: '8px 0' }} fullWidth>Sign in</Button>
